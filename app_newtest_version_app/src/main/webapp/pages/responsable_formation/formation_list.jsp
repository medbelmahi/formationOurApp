...
<head>
	...
	<title>Responsable de formation : Gestion des formations</title>
...
<section>
    <!-- left side start-->
		<s:include value="/administrateur/include/left_side_bar.jsp"></s:include>
    <!-- left side end-->
    ...
    <div class="main-content" >
        ...
        <div class="page-heading">
            <h3>
                Responsable de formation <small>Gestion des formations</small>
            </h3>
        </div>
        <!-- page heading end-->
        ...
        <div class="wrapper">
			...
			<%-- <!-- Begin Send Message to collaborateurs Modal -->
...
// 						sleep(1000);
	...
	<!-- Begin Initialisation cellspacing table of formation  -->
	<script type="text/javascript">
...
// 		    return sOut;
	...
	<!-- End Initialisation cellspacing table of formation  -->
