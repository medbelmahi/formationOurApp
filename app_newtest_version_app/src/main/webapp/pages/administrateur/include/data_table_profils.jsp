											...
											<td><s:property value="description" /></td>
												...
												<td class="center hidden-phone ">
													<ul style="list-style: none;" class="navbar-nav nav-options">
														...
														<li style="padding-left: 15px;">
															<a data-href='<s:url action="deleteProfil" ><s:param name="id"><s:property value="idProfil"/></s:param></s:url>' data-toggle="confirmation" data-original-title="" title="Supprimer ?" >
